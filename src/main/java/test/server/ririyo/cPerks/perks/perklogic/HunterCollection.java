...
public class HunterCollection {
    ...
    public static Map<EntityType, Integer> mobExperience = Map.<EntityType, Integer>ofEntries(
            ///PASSIVES
            Map.entry(EntityType.COW, 1),
            Map.entry(EntityType.MOOSHROOM, 1),
            Map.entry(EntityType.PIG, 1),
            Map.entry(EntityType.ARMADILLO, 1),
            Map.entry(EntityType.FROG, 1),
            Map.entry(EntityType.SHEEP, 1),
            Map.entry(EntityType.CHICKEN, 1),
            Map.entry(EntityType.PANDA, 1),
            Map.entry(EntityType.TURTLE, 1),
            Map.entry(EntityType.BAT, 1),
            Map.entry(EntityType.SQUID, 1),
            Map.entry(EntityType.GLOW_SQUID, 1),
            Map.entry(EntityType.RABBIT, 1),
            Map.entry(EntityType.GOAT, 2),
            Map.entry(EntityType.CAMEL, 2),
            Map.entry(EntityType.LLAMA, 2),
            Map.entry(EntityType.POLAR_BEAR, 2),
            Map.entry(EntityType.WOLF, 2),
            Map.entry(EntityType.DONKEY, 2),
            Map.entry(EntityType.HORSE, 2),
            ...
            Map.entry(EntityType.SKELETON, 3),
            Map.entry(EntityType.STRAY, 3),
            Map.entry(EntityType.CREEPER, 3),
            Map.entry(EntityType.SPIDER, 3),
            Map.entry(EntityType.CAVE_SPIDER, 3),
            Map.entry(EntityType.PILLAGER, 3),
            Map.entry(EntityType.ZOMBIE_VILLAGER, 3),
            Map.entry(EntityType.DROWNED, 3),
            Map.entry(EntityType.GUARDIAN, 3),
            Map.entry(EntityType.ZOGLIN, 4),
            Map.entry(EntityType.PHANTOM, 4),
            ...
            Map.entry(EntityType.MAGMA_CUBE, 3),
            Map.entry(EntityType.ZOMBIFIED_PIGLIN, 3),
            Map.entry(EntityType.PIGLIN, 3),
            Map.entry(EntityType.HOGLIN, 4),
            Map.entry(EntityType.WITHER_SKELETON, 4),
            Map.entry(EntityType.GHAST, 4),
            Map.entry(EntityType.PIGLIN_BRUTE, 5),

            ///HOSTILES-END
            Map.entry(EntityType.SHULKER, 3),
            Map.entry(EntityType.ENDERMITE, 3),
            Map.entry(EntityType.ENDERMAN, 5),
